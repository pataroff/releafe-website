...
const Custom404Page = () => {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-b from-[#c5d5bc] to-[#8fa58b] px-8">
      <div className="rounded-3xl overflow-hidden flex flex-col text-center p-8 gap-y-8 xl:gap-y-12 bg-white shadow-xl">
        ...
        <Link
          href="/"
          className="flex justify-center items-center rounded-full h-[50px] lg:h-[60px] w-full mt-4 bg-gradient-to-b from-[#c5d5bc] to-[#8fa58b] transform duration-300 ease-in-out font-sofia font-bold text-white text-lg xl:text-xl leading-none"
        >
