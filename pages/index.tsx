...
import { homePageQuery, settingsQuery, articlesQuery } from 'lib/sanity.queries'
...
export default function IndexPage(props: PageProps) {
  const { page, settings, draftMode, articles } = props

  if (draftMode) {
    return <HomePagePreview page={page} settings={settings} />
  }

  return <HomePage page={page} settings={settings} articles={articles} />
}
