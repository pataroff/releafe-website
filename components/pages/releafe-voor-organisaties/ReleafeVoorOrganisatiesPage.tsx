...
const ReleafeVoorOrganisatiesPage = ({ settings, navbar, page }) => {
        ...
        <div className="flex flex-col xl:flex-row min-h-full w-full">
          ...
          <div className="flex flex-col justify-center h-full w-full xl:w-1/2 bg-[#c5d5bc] bg-opacity-15 gap-y-12 px-12 xl:px-24 pb-4 xl:pb-8 pt-28 xl:pt-12 2xl:pt-16">
            ...
            <h3 className="text-md 2xl:text-xl font-sofia font-light">
              Mentale gezondheid op het werk is belangrijk. Stress, burn-out en
              andere mentale klachten komen steeds vaker voor. Dit heeft niet
              alleen invloed op je medewerkers, maar ook op je organisatie.
              Gelukkige en gezonde medewerkers presteren beter, zijn minder vaak
              ziek en blijven langer bij je werken. Releafe helpt jouw
      ...
      <div className="bg-gradient-to-b from-white via-[#c5d5bc50] to-white h-full">
        ...
        >
          ...
          <p className="mt-4 font-sofia font-light text-center text-md xl:text-xl">
            Releafe biedt medewerkers de tools om grip te krijgen op hun mentale
            welzijn en geeft bedrijven waardevolle inzichten om een gezonde
            werkomgeving te creëren. Van persoonlijke ondersteuning tot
            geanonimiseerde groepsanalyses: ontdek hoe Releafe bijdraagt aan een
            veerkrachtige en productieve organisatie. Klik op de links voor meer
            informatie!
          </p>
        </section>
