  ...
  return (
    <>
        ...
        <div className="flex flex-col xl:flex-row min-h-full w-full">
          ...
          <div className="flex flex-col justify-center h-full w-full xl:w-1/2 bg-[#c5d5bc] bg-opacity-15 gap-y-12 px-12 xl:px-24 pb-4 xl:pb-8 pt-28 xl:pt-12 2xl:pt-16">
            ...
            <h3 className="text-md xl:text-lg 2xl:text-xl font-sofia font-light">
              Mentale klachten? Iedereen heeft er weleens mee te maken. Van een
              dipje tot serieuzere dingen, het kan ons allemaal overkomen. Het
              belangrijkste is: je staat er niet alleen voor. Releafe is er om
              je te steunen, wat er ook speelt. Heb je last van onderstaande
              klachten? Releafe helpt je om mentaal sterk te worden én te
              blijven. Ontdek hier wat we voor je kunnen doen.
            </h3>
      ...
      <div className="bg-gradient-to-b from-white via-[#c5d5bc50] to-white h-full">
        <div className="mt-[2rem] xl:mt-[6rem] px-8 lg:px-16 xl:px-32 max-w-[1440px] place-self-center">
          ...
          <p className="mt-4 font-sofia font-light text-center text-md xl:text-xl">
            ...
            Check onderstaande veelvoorkomende klachten en ontdek hoe Releafe je
            kan helpen en ondersteunen. Heb je behoefte aan meer info? Klik dan
            door naar betrouwbare bronnen zoals Thuisarts.nl.
          </p>
        </div>
                          ...
                          {additionalData.map((subdisorder, index) => {
                            return (
                              <button
                                ...
                                className={`${fearSubdisorderIndex === index ? 'bg-gradient-to-b from-[#d4e3c4] to-[#849b6f] text-white' : 'bg-gray-200 hover:bg-gray-300'} rounded-lg text-md xl:text-lg font-sofia font-semibold ${fearSubdisorderIndex === index ? 'text-white' : 'text-black'} text-nowrap py-2 px-10 transition duration-300 ease-in-out`}
                              >
                                {subdisorder.title}
                              </button>
                            )
      ...
      <section className="my-[4rem] lg:my-[6rem] px-8 lg:px-16 xl:px-32 flex flex-col justify-center items-center place-self-center gap-y-8 max-w-[1440px]">
        ...
        <p className="mt-4 text-center font-sofia font-light text-lg xl:text-xl">
          ...
          ervaart? Op de Mentaal fit pagina ontdek je wat je zelf kan doen om je
          mentale gezondheid een boost te geven en te onderhouden.
        </p>
